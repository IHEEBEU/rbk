 ...
 * @this {Tree} - root node
 */
Tree.prototype.countLeaves = function (arr) {
  // TODO: implement me!
  var xd = arr || this.children;
  
  if (typeof xd[1] !== "object") {
    this.value++;
  } else if (typeof xd[1] === "undefined") {
    return this.value++;
  } else if (typeof xd[0] === "object") {
    return this.countLeaves(xd[0]); 
  }
};
