...
- Turn off all communication devices such as your phone, email, etc.
...
_**Inheritance-pseudo-classical**_

    Rewrite `makeCar` and `makeRealCar` to use pseudo-classical inheritance
